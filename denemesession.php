...
<nav class="navbar navbar-expand-md sticky-top py-3 navbar-dark" id="mainNav">
    <div class="container">
        <a data-bss-hover-animate="flash" href=""><img src="assets/img/farm.png" width="58" height="58"></a>
        <a class="navbar-brand d-flex align-items-center" href="#">Farmer Tracker</a>
            ...
            <ul class="navbar-nav ms-auto">
                <?php if (isset($nameSurname)): ?>
                    <li class="nav-item"><a class="nav-link"
                                            href="#">Hoşgeldin <?php echo htmlspecialchars($nameSurname); ?></a></li>
                <?php endif; ?>
            </ul>
        </div>
    </div>
            ...
            <div class="col-md-6 col-xl-4">
                <div>
                    <form class="p-3 p-xl-4" method="post">
                        ...
                        <div class="mb-3"></div>
                        <div>
                            <button class="btn btn-primary text-center shadow d-block w-100" type="submit"
                                    style="padding-top: 17px; padding-right: 37px; padding-bottom: 17px; padding-left: 37px;
                   background: var(--bs-info-text-emphasis); color: white;"
                                    onmouseover="this.style.backgroundColor='rgba(0, 155, 127, 0.87)'"
                                    onmouseout="this.style.backgroundColor='var(--bs-info-text-emphasis)'">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"
                                     fill="none"
                                     style="font-size: 35px; padding-right: 0px; padding-left: 0px; margin-left: -13px; margin-right: 14px;">
                ...
                <div>
                   ...
                   background: var(--bs-info-text-emphasis); color: white;"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"
                                     fill="none"
                                     style="font-size: 35px; padding-right: 0px; padding-left: 0px; margin-left: -13px; margin-right: 14px;">
                                    <path d="M10 12C9.44769 12 9 12.4477 9 13C9 13.5523 9.44769 14 10 14H14C14.5522 14 15 13.5523 15 13C15 12.4477 14.5522 12 14 12H10Z"
                                          fill="currentColor"></path>
                                    <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div class="col-md-6 col-xl-4">
                <div>
                   ...
                   background: var(--bs-info-text-emphasis); color: white;"
                                    onmouseover="this.style.backgroundColor='rgba(0, 155, 127, 0.87)'"
                                    onmouseout="this.style.backgroundColor='var(--bs-info-text-emphasis)'">
                                <svg class="icon icon-tabler icon-tabler-password-user"
...
<footer class="bg-dark fixed-bottom">
    <div class="container py-4 py-lg-5">
        ...
        <div class="text-muted d-flex justify-content-between align-items-center pt-3">
            <p class="mb-0">Copyright © 2024 Kocaturk</p>
